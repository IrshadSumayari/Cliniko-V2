...
export default function TutorialCard() {
  ...
  const sections = [
    ...
    },
    {
      ...
      description: "Quickly find patients by name or filter by program (EPC/WC), physio, or location.",
    },
    {
      icon: Filter,
      title: "Patient Tabs",
          ...
          <CardContent className="pt-0">
            <div className="grid gap-4 md:grid-cols-2">
              {sections.map((section, index) => (
                <div key={index} className="flex gap-3 p-3 rounded-lg bg-muted/20 border border-border/50">
