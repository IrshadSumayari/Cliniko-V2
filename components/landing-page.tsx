  ...
  const plans = [
    {
      ...
      price: 'Free',
      period: '7-day trial',
      description: 'Perfect for small clinics who want clarity without the admin stress',
      features: ['Up to 50 patients', 'Basic session tracking', 'Email alerts', 'Standard support'],
    ...
    },
    {
      ...
      price: '$29',
      period: 'per month',
      description: 'Protect up to $10,000+ in revenue each month and keep your team in control',
      features: [
        'Up to 500 patients',
        'Advanced analytics',
        'SMS & email alerts',
    ...
    },
    {
      ...
      price: '$79',
      period: 'per month',
      description: 'For large multi-site clinics needing full visibility across locations',
      features: [
        'Unlimited patients',
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-6 py-20">
          <div className="text-center max-w-4xl mx-auto animate-fade-in">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-6 leading-relaxed max-w-3xl mx-auto">
              MyPhysioFlow connects to your clinic software and automatically tracks EPC & Workers'
              Compensation sessions, renewals and approvals – so nothing slips through the cracks
              and your team can finally breathe.
            </p>

            <div className="bg-accent/50 border border-primary/20 rounded-lg p-4 mb-8 max-w-2xl mx-auto">
              <p className="text-sm font-medium text-muted-foreground mb-2">
                <strong>No extra admin work</strong> – connect your PMS once and MyPhysioFlow runs
                in the background.
              </p>
              <p className="text-sm text-muted-foreground">
                CTP tracking and other funding schemes are coming soon – early access for annual
                plans.
              </p>
            </div>
            ...
            <p className="text-sm text-muted-foreground mb-8">
              Try it free for 7 days – no credit card. After your trial, choose monthly or
              ...
              <div className="luxury-card p-8 bg-gradient-to-r from-destructive/5 to-warning/5 border border-destructive/20">
                <div className="text-center space-y-3">
                  <p className="text-xl font-semibold text-foreground">
                    Most clinics are overwhelmed with admin – and it&apos;s costing them patients
                    and revenue.
                  </p>
                  <p className="text-lg text-muted-foreground">
                    MyPhysioFlow removes the stress by flagging exactly who needs action before
                    things go wrong.
                  </p>
                </div>
              </div>
              ...
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-12">
                  ...
                  <p className="text-sm text-muted-foreground mb-2">
                    Trusted by 500+ Australian Physio Clinics Who Value Clarity & Control
                  </p>
            ...
            <div className="animate-fade-in" style={{ animationDelay: '0.6s' }}>
              <div className="text-center mb-8">
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  Filter by physio or clinic location instantly to see only the patients relevant to
                  you.
                </p>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-4 max-w-6xl mx-auto mb-8">
                  ...
                  <div className="bg-card/50 border border-warning/20 rounded-lg p-4">
                    ...
                    <h4 className="font-semibold text-sm mb-1">Action Needed</h4>
                    <p className="text-xs text-muted-foreground">
                ...
                <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 mb-8 max-w-2xl mx-auto">
                  ...
                  <p className="text-xs text-muted-foreground">
                    During setup, you'll review our initial sync and confirm quotas so the system
                    starts perfectly accurate.
                  </p>
                </div>
              </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              See how clinics are saving thousands with automated session tracking
            </p>
          </div>
            ...
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-sm text-primary">{testimonial.clinic}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-8">
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Get instant email alerts when a patient is close to their quota or pending approvals
            ...
            <div className="bg-card border border-border rounded-lg p-6 max-w-2xl mx-auto shadow-lg">
              <div className="border border-border rounded p-4 bg-background/50">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="text-sm font-semibold">MyPhysioFlow Alert</span>
                </div>
                <p className="text-sm text-left">
                  <strong>Action Required:</strong> Sarah Johnson (EPC #12345) has 1 session
                  remaining. Referral expires in 5 days. Consider booking renewal appointment.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Your data never leaves Australia – hosted on encrypted Australian servers with Privacy
              Act 1988 compliance.
            </p>
      ...
      <section id="features" className="py-24">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Finally Feel in <span className="text-primary">Control of Your Clinic</span> Again
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Stop feeling overwhelmed by admin work. MyPhysioFlow gives you clarity and peace of
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-24 bg-gradient-to-b from-background to-accent/30">
        <div className="container mx-auto px-6">
          <div className="text-center mb-8">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-6">
              Choose the plan that fits your clinic size. All plans include our core session
              tracking features.
            </p>
          ...
          <div className="text-center mt-12">
            <p className="text-muted-foreground mb-4">
              Need a custom solution? We offer enterprise packages for large healthcare networks.
            </p>
      ...
      <section id="support" className="py-24">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Get the support you need, when you need it. Our team of healthcare technology experts
              is ready to assist.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto mb-16">
            {[
              ...
              >
                ...
                <p className="text-muted-foreground mb-4 text-sm">{support.description}</p>
      ...
      <section className="py-20 bg-gradient-to-r from-secondary/10 to-accent/10 border-y border-border/20">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-6">
              We're developing comprehensive CTP tracking, NDIS management, and automated insurer
              report generation to complete your clinic's needs.
            </p>
            <div className="bg-primary/5 border border-primary/20 rounded-lg p-6 mb-8">
              <p className="text-sm font-semibold text-primary mb-2">🎯 Early Access Benefit</p>
              <p className="text-sm text-muted-foreground">
                Annual plans get first access to new features like CTP tracking and auto-generated
                insurer reports.
              </p>
            </div>
            <Button
        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-10 max-w-3xl mx-auto">
              Join hundreds of Australian clinics who no longer feel overwhelmed by session tracking
              and compliance.
            </p>
      ...
      <footer className="border-t border-border bg-card py-12">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Automated session tracking for healthcare practices. Never lose revenue on expired
                sessions again.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-border pt-8 text-center text-sm text-muted-foreground">
            <p>
              &copy; 2024 MyPhysioFlow. All rights reserved. Made with ❤️ for healthcare
              professionals.
            </p>
          </div>
        </div>
